...
function reqlatest() {
    axios.get(httpUrl).then((res) => {
        queryHandle1('TRUNCATE TABLE latest')
            // 全球最新统计
    ...
    axios.get(httpUrl).then((res) => {
        ...
        if (res.data.recommends.length !== 0) {
            queryHandle1('TRUNCATE TABLE recommends')
    ...
    axios.get(httpUrl).then((res) => {
        ...
        if (res.data.remarks.length !== 0) {
            queryHandle1('TRUNCATE TABLE info1')
    ...
    axios.get(httpUrl).then((res) => {
        ...
        if (res.data.rumors.length !== 0) {
            queryHandle1('TRUNCATE TABLE rumors')
    ...
    axios.get(httpUrl).then((res) => {
        ...
        if (res.data.goodsGuides.length !== 0) {
            queryHandle1('TRUNCATE TABLE goodsGuides')
    ...
    axios.get(httpUrl).then((res) => {
        ...
        if (res.data.timelines.length !== 0) {
            queryHandle1('TRUNCATE TABLE timelines')
    ...
    axios.get(httpUrl).then((res) => {
        // wikis（维基百科）
        queryHandle1('TRUNCATE TABLE wikis')
    ...
    axios.get(httpUrl).then((res) => {
        // notes（注释）
        queryHandle1('TRUNCATE TABLE notes')
