        ...
        $.ajax({
          ...
          success:function(data){
			...
			for(let i=0; i<newData.length; i++){
			 ...
			 // option_left1.xAxis.data = xData
			 option_left1.xAxis.data = ['20-02','20-03','20-04','20-05','20-06','20-07','20-08','20-09','20-10','20-11','20-12','21-01']
             option_left1.series[0].data = series1
			 option_left1.series[1].data = series2
			 option_left1.series[2].data = series3
			 option_left1.series[3].data = series4
             myChart.setOption(option_left1)
          }
        })
         myChart.setOption(option_left1)
      }
